...
#pragma region SceneSetup
	...
	rtx::Plane p6(rtx::Vector3(0.f, 0.f, -4.f), rtx::Vector3(0.f, 0.f, -1.f));
	...
	// Lights
	PointLight light1(rtx::Vector3(0.f, 1.f, 0.f), 
...
#pragma endregion
	...
	std::shared_ptr<Camera> perspCamera = std::make_shared<PerspectiveCamera>(
		WIDTH, HEIGHT, 10.f, FOV, rtx::Vector3(0, 0, -12.0f), rtx::Vector3::Zero());
