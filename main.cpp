...
#pragma region SceneSetup
	...
	Material sm1(Color(Color::GRAY), 128.f, 5.f, 2.f, -4.f);
	std::shared_ptr<SphereRenderable> sphere1 = std::make_shared<SphereRenderable>(sm1, s1);
	
	rtx::Sphere s2(rtx::Vector3(0.5f, 0.5f, 0.f), 0.33f);
	...
	Material pm1(Color(Color::RED), 128.f, 1.f, 0.f, 0.f);
	...
	Material pm2(Color(Color::GREEN), 128.f, 1.f, 0.f, 0.f);
	...
	Material pm3(Color(Color::BLUE), 128.f, 1.f, 0.f, 0.f);
	...
	Material pm4(Color(Color::CYAN), 128.f, 1.f, 0.f, 0.f);
	std::shared_ptr<PlaneRenderable> plane4 = std::make_shared<PlaneRenderable>(pm4, p4);

	rtx::Plane p5(rtx::Vector3(0.f, 0.f, 8.f), rtx::Vector3(0.f, 0.f, 1.f));
	Material pm5(Color(Color::YELLOW), 128.f, 1.f, 0.f, 0.f);
	...
	Material pm6(Color(Color::MAGENTA), 128.f, 1.f, 0.f, 0.f);
...
#pragma endregion
	...
	std::shared_ptr<Camera> perspCamera = std::make_shared<PerspectiveCamera>(
		WIDTH, HEIGHT, 100.f, 90.f, rtx::Vector3(0, 0, -5.f), rtx::Vector3(0, 0, 1.f));
