...
#pragma region SceneSetup
	...
	rtx::Plane p2(rtx::Vector3(-5.f, 0.f, 0.f), rtx::Vector3(-1.f, 0.f, 0.f));
	...
	rtx::Plane p3(rtx::Vector3(0.f, 5.f, 0.f), rtx::Vector3(0.f, 1.f, 0.f));
	...
	rtx::Plane p4(rtx::Vector3(0.f, -5.f, 0.f), rtx::Vector3(0.f, -1.f, 0.f));
	...
	rtx::Plane p5(rtx::Vector3(0.f, 0.f, 5.f), rtx::Vector3(0.f, 0.f, 1.f));
	...
	rtx::Plane p6(rtx::Vector3(0.f, 0.f, -5.f), rtx::Vector3(0.f, 0.f, -1.f));
...
#pragma endregion
	...
	std::shared_ptr<Camera> perspCamera = std::make_shared<PerspectiveCamera>(
		WIDTH, HEIGHT, 10.f, FOV, rtx::Vector3(0, 0, -5.0f), rtx::Vector3::Zero());
